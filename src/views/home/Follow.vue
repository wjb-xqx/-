<template>
    <div class="follow">
        <div class="links">
            ...
            <ul>
                <li v-for="(item,index) in personList" :key="index">
                    <router-link tag="a" :to="'/userPage/'+item.id">
                        <div class="img">
        ...
        <div class="links edition">
            <h3>
                <img src="@/assets/images/index.png" alt="">
                你可能感兴趣的版区
            </h3>
            <ul>
                <li v-for="(item,index) in containerList" :key="index">
                    <router-link tag="a" :to="'/ComicImg/'+item.id">
                        <div class="img">
                            <img :src="item.url" alt="">
                        </div>
                        <p class="name">{{item.name}}</p>
...
<style lang="less" scoped>
 .links{
        ...
        >.change{
            padding: 45/50rem 30/50rem 10/50rem;
            text-align: center;
            color:#FD4C86;
            font-size: 16/50rem;
        }
